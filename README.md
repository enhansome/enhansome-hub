...
* 非常感谢阮一峰老师的[科技爱好者周刊](https://github.com/ruanyf/weekly) ⭐ 100,581 | 🐛 8,729 | 📅 2026-08-14提供的分享
...
[openpilot](https://github.com/commaai/openpilot) ⭐ 63,432 | 🐛 119 | 🌐 Python | 📅 2026-08-17\
...
[Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,258 | 🐛 123 | 🌐 Jupyter Notebook | 📅 2024-08-17\
...
[如何在抖音上找到漂亮小姐姐？](https://github.com/wangshub/Douyin-Bot) ⭐ 9,627 | 🐛 65 | 🌐 Python | 📅 2023-10-03\
...
[github-contributions-chart](https://github.com/sallar/github-contributions-chart) ⭐ 5,601 | 🐛 34 | 🌐 JavaScript | 📅 2025-02-20（[Demo](https://github-contributions.now.sh/)）\
...
[Remote Browser](https://github.com/intoli/remote-browser) ⭐ 1,749 | 🐛 8 | 🌐 JavaScript | 📅 2018-07-14\
一个浏览器自动化框架，可以用脚本控制已经打开的浏览器。

## 效率 <a name="good"></a>

[read-aloud](https://github.com/ken107/read-aloud) ⭐ 1,724 | 🐛 133 | 🌐 JavaScript | 📅 2026-07-10
...
[Bing Wallpaper](https://github.com/niumoo/bing-wallpaper) ⭐ 3,672 | 🐛 4 | 🌐 Java | 📅 2026-08-17\
...
[Build your own x](https://github.com/danistefanovic/build-your-own-x) ⭐ 540,370 | 🐛 630 | 🌐 Markdown | 📅 2026-07-14\
这个仓库专门收集各种教程，教你如何自己实现各种软件，比如 Web 服务器、BT 下载客户端、Git、数据库等等。

[Remark42](https://github.com/umputun/remark42) ⭐ 5,579 | 🐛 99 | 🌐 Go | 📅 2026-08-11\
![](https://www.wangbase.com/blogimg/asset/202102/bg2021020710.jpg)\
一个开源的、可以自己搭建的网站留言服务。

[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,124 | 🐛 170 | 🌐 Python | 📅 2026-08-17\
...
[hackernews-daily](https://github.com/headllines/hackernews-daily) ⭐ 689 | 🐛 2,210 | 🌐 JavaScript | 📅 2024-01-19\
...
[EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,913 | 🐛 530 | 🌐 Python | 📅 2025-12-05\
...
[monica](https://github.com/monicahq/monica) ⭐ 25,049 | 🐛 787 | 🌐 PHP | 📅 2026-04-24\
...
[awesome-qrcode](https://github.com/ruanyf/weekly/issues/795) ⭐ 100,581 | 🐛 8,729 | 📅 2026-08-14\
...
[you-get](https://github.com/soimort/you-get) ⭐ 56,869 | 🐛 386 | 🌐 Python | 📅 2026-07-25\
...
[OpenCC](https://github.com/BYVoid/OpenCC) ⭐ 9,904 | 🐛 51 | 🌐 C++ | 📅 2026-08-14\
...
[reminiscence](https://github.com/kanishka-linux/reminiscence) ⭐ 1,853 | 🐛 27 | 🌐 JavaScript | 📅 2024-04-23\
...
[字体裁剪工具](https://github.com/2234839/web-font) ⭐ 295 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-15\
...
[ImmortalDB](https://github.com/gruns/ImmortalDB) ⭐ 3,060 | 🐛 39 | 🌐 JavaScript | 📅 2025-04-18\
...
[arwes](https://github.com/arwesjs/arwes) ⭐ 7,552 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-05\
![](https://www.wangbase.com/blogimg/asset/201811/bg2018110921.jpg)\
一个质量不错的科幻风格 React UI 组件库。

[retejs](https://github.com/retejs/rete) ⭐ 12,214 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24\
...
[JavaScript 算法与数据结构](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md) ⭐ 196,495 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26\
...
[css-protips](https://github.com/AllThingsSmitty/css-protips/tree/master/translations/zh-CN) ⭐ 30,250 | 🐛 2 | 📅 2025-03-20\
一个收集 CSS 使用技巧的库。
...
[bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) ⭐ 9,195 | 🐛 718 | 🌐 JavaScript | 📅 2026-08-17\
...
[kutt](https://github.com/thedevs-network/kutt) ⭐ 11,032 | 🐛 78 | 🌐 JavaScript | 📅 2026-08-17\
开源的短链接生成器，基于 Node.js，允许自定义短链接、设置链接密码，还提供访问统计。

[snapdrop](https://github.com/RobinLinus/snapdrop) ⭐ 19,708 | 🐛 288 | 🌐 JavaScript | 📅 2025-02-10\
一个开源的文件分享服务，使用 WebRTC 协议进行点对点传输。

[tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,634 | 🐛 46 | 🌐 JavaScript | 📅 2026-05-17\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019062823.jpg)\
一个可以完成 62 种语言 OCR （光学识别）的 JS 库。

[如何使用 GitHub issue 作为博客后端？](https://github.com/ruanyf/weekly/issues/585) ⭐ 100,581 | 🐛 8,729 | 📅 2026-08-14\
...
[pygmy](https://github.com/amitt001/pygmy) ⭐ 727 | 🐛 18 | 🌐 Python | 📅 2024-03-07\
...
[bat](https://github.com/sharkdp/bat) ⭐ 60,192 | 🐛 420 | 🌐 Rust | 📅 2026-08-11\
...
[node best practices](https://github.com/i0natan/nodebestpractices) ⭐ 105,578 | 🐛 136 | 🌐 Dockerfile | 📅 2026-06-15\
一个收集  Node 最佳实践的仓库。
...
[Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days) ⭐ 185,270 | 🐛 704 | 🌐 Jupyter Notebook | 📅 2026-07-29\
一本针对初学者的 Python 教程。
...
这是很久以来，我见过的最酷主页，整个页面都是 3D 的。[页面源码](https://github.com/brunosimon/folio-2019) ⭐ 4,730 | 🐛 40 | 🌐 JavaScript | 📅 2024-05-25是开源的。
