...
* 非常感谢阮一峰老师的[科技爱好者周刊](https://github.com/ruanyf/weekly) ⭐ 102,680 | 🐛 9,110 | 📅 2026-09-13提供的分享
...
[openpilot](https://github.com/commaai/openpilot) ⭐ 63,660 | 🐛 139 | 🌐 Python | 📅 2026-09-16\
...
[Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,399 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17\
...
该工具可以将 JS 项目的源代码显示为一座城市。还有一个类似的[项目](https://github.com/rodrigo-brito/gocity) ⭐ 1,809 | 🐛 10 | 🌐 Go | 📅 2025-12-05，专用于 Go 语言。
...
[chinese-xinhua](https://github.com/pwxcoo/chinese-xinhua) ⭐ 11,680 | 🐛 38 | 🌐 Python | 📅 2023-12-26\
...
[read-aloud](https://github.com/ken107/read-aloud) ⭐ 1,746 | 🐛 134 | 🌐 JavaScript | 📅 2026-07-10
...
[Clone Wars](https://github.com/GorvGoyl/Clone-Wars) ⭐ 36,757 | 🐛 40 | 📅 2024-08-06\
...
[Bing Wallpaper](https://github.com/niumoo/bing-wallpaper) ⭐ 3,719 | 🐛 3 | 🌐 Java | 📅 2026-09-16\
...
[Build your own x](https://github.com/danistefanovic/build-your-own-x) ⭐ 547,632 | 🐛 643 | 🌐 Markdown | 📅 2026-07-14\
...
[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,467 | 🐛 162 | 🌐 Python | 📅 2026-09-16\
...
[hackernews-daily](https://github.com/headllines/hackernews-daily) ⭐ 690 | 🐛 2,240 | 🌐 JavaScript | 📅 2024-01-19\
...
[EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,994 | 🐛 531 | 🌐 Python | 📅 2025-12-05\
...
[monica](https://github.com/monicahq/monica) ⭐ 25,316 | 🐛 795 | 🌐 PHP | 📅 2026-04-24\
...
[awesome-qrcode](https://github.com/ruanyf/weekly/issues/795) ⭐ 102,680 | 🐛 9,110 | 📅 2026-09-13\
二维码生成工具，可以生成静态二维码、图像二维码和动画二维码。

[Rough.js](https://github.com/pshihn/rough/) ⭐ 21,177 | 🐛 42 | 🌐 HTML | 📅 2024-07-28\
...
[OpenCC](https://github.com/BYVoid/OpenCC) ⭐ 9,984 | 🐛 51 | 🌐 C++ | 📅 2026-09-09\
...
[Feature Icons](https://github.com/feathericons/feather) ⭐ 25,995 | 🐛 510 | 🌐 JavaScript | 📅 2025-03-11\
...
[craft.js](https://github.com/prevwong/craft.js) ⭐ 8,746 | 🐛 227 | 🌐 TypeScript | 📅 2025-02-14\
...
[jimp](https://github.com/oliver-moran/jimp) ⭐ 14,662 | 🐛 188 | 🌐 TypeScript | 📅 2026-04-07\
...
[arwes](https://github.com/arwesjs/arwes) ⭐ 7,559 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-05\
![](https://www.wangbase.com/blogimg/asset/201811/bg2018110921.jpg)\
一个质量不错的科幻风格 React UI 组件库。

[retejs](https://github.com/retejs/rete) ⭐ 12,258 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-13\
...
[JavaScript 算法与数据结构](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md) ⭐ 196,736 | 🐛 406 | 🌐 JavaScript | 📅 2026-07-26\
...
[css-protips](https://github.com/AllThingsSmitty/css-protips/tree/master/translations/zh-CN) ⭐ 30,276 | 🐛 1 | 📅 2026-08-24\
一个收集 CSS 使用技巧的库。
...
[bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) ⭐ 9,217 | 🐛 723 | 🌐 JavaScript | 📅 2026-09-15\
...
[kutt](https://github.com/thedevs-network/kutt) ⭐ 11,101 | 🐛 83 | 🌐 JavaScript | 📅 2026-09-03\
开源的短链接生成器，基于 Node.js，允许自定义短链接、设置链接密码，还提供访问统计。

[snapdrop](https://github.com/RobinLinus/snapdrop) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15\
一个开源的文件分享服务，使用 WebRTC 协议进行点对点传输。

[tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,710 | 🐛 53 | 🌐 JavaScript | 📅 2026-05-17\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019062823.jpg)\
一个可以完成 62 种语言 OCR （光学识别）的 JS 库。

[如何使用 GitHub issue 作为博客后端？](https://github.com/ruanyf/weekly/issues/585) ⭐ 102,680 | 🐛 9,110 | 📅 2026-09-13\
...
[Night-Reading-Go](https://github.com/developer-learning/night-reading-go) ⭐ 12,287 | 🐛 9 | 🌐 Go | 📅 2026-09-15\
...
[bat](https://github.com/sharkdp/bat) ⭐ 60,469 | 🐛 518 | 🌐 Rust | 📅 2026-09-04\
...
[faceai](https://github.com/vipstone/faceai) ⭐ 11,087 | 🐛 38 | 🌐 Python | 📅 2020-04-16\
...
[node best practices](https://github.com/i0natan/nodebestpractices) ⭐ 105,626 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15\
一个收集  Node 最佳实践的仓库。
...
[Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days) ⭐ 186,523 | 🐛 716 | 🌐 Jupyter Notebook | 📅 2026-07-29\
一本针对初学者的 Python 教程。
...
这是很久以来，我见过的最酷主页，整个页面都是 3D 的。[页面源码](https://github.com/brunosimon/folio-2019) ⭐ 4,745 | 🐛 40 | 🌐 JavaScript | 📅 2024-05-25是开源的。
...
[Google CTF 的试题](https://github.com/google/google-ctf) ⭐ 5,025 | 🐛 1 | 🌐 Python | 📅 2026-09-15\
