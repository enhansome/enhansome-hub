...
* 非常感谢阮一峰老师的[科技爱好者周刊](https://github.com/ruanyf/weekly) ⭐ 102,140 | 🐛 8,959 | 📅 2026-09-04提供的分享
...
[openpilot](https://github.com/commaai/openpilot) ⭐ 63,596 | 🐛 143 | 🌐 Python | 📅 2026-09-07\
...
[Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,365 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17\
...
[chinese-xinhua](https://github.com/pwxcoo/chinese-xinhua) ⭐ 11,673 | 🐛 38 | 🌐 Python | 📅 2023-12-26\
...
[Clone Wars](https://github.com/GorvGoyl/Clone-Wars) ⭐ 36,722 | 🐛 40 | 📅 2024-08-06\
...
[Bing Wallpaper](https://github.com/niumoo/bing-wallpaper) ⭐ 3,709 | 🐛 3 | 🌐 Java | 📅 2026-09-07\
...
[Build your own x](https://github.com/danistefanovic/build-your-own-x) ⭐ 545,789 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14\
这个仓库专门收集各种教程，教你如何自己实现各种软件，比如 Web 服务器、BT 下载客户端、Git、数据库等等。

[Remark42](https://github.com/umputun/remark42) ⭐ 5,606 | 🐛 105 | 🌐 Go | 📅 2026-09-07\
![](https://www.wangbase.com/blogimg/asset/202102/bg2021020710.jpg)\
一个开源的、可以自己搭建的网站留言服务。

[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,250 | 🐛 160 | 🌐 Python | 📅 2026-09-07\
...
[hackernews-daily](https://github.com/headllines/hackernews-daily) ⭐ 690 | 🐛 2,231 | 🌐 JavaScript | 📅 2024-01-19\
...
[EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,979 | 🐛 530 | 🌐 Python | 📅 2025-12-05\
...
一个点对点的文件在线传输工具，利用 Webrtc 在两台电脑之间建立直接连接，代码[开源](https://github.com/saljam/webwormhole) ⭐ 2,085 | 🐛 13 | 🌐 Go | 📅 2025-12-22。
...
[monica](https://github.com/monicahq/monica) ⭐ 25,244 | 🐛 795 | 🌐 PHP | 📅 2026-04-24\
...
[awesome-qrcode](https://github.com/ruanyf/weekly/issues/795) ⭐ 102,140 | 🐛 8,959 | 📅 2026-09-04\
...
[OpenCC](https://github.com/BYVoid/OpenCC) ⭐ 9,964 | 🐛 50 | 🌐 C++ | 📅 2026-08-26\
...
[retejs](https://github.com/retejs/rete) ⭐ 12,237 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24\
...
[JavaScript 算法与数据结构](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md) ⭐ 196,645 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26\
...
[img-2](https://github.com/RevillWeb/img-2) ⭐ 1,879 | 🐛 7 | 🌐 HTML | 📅 2018-05-22\
...
[bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) ⭐ 9,211 | 🐛 723 | 🌐 JavaScript | 📅 2026-09-04\
...
[kutt](https://github.com/thedevs-network/kutt) ⭐ 11,082 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-03\
开源的短链接生成器，基于 Node.js，允许自定义短链接、设置链接密码，还提供访问统计。

[snapdrop](https://github.com/RobinLinus/snapdrop) ⭐ 19,709 | 🐛 287 | 🌐 JavaScript | 📅 2025-02-10\
一个开源的文件分享服务，使用 WebRTC 协议进行点对点传输。

[tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,694 | 🐛 49 | 🌐 JavaScript | 📅 2026-05-17\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019062823.jpg)\
一个可以完成 62 种语言 OCR （光学识别）的 JS 库。

[如何使用 GitHub issue 作为博客后端？](https://github.com/ruanyf/weekly/issues/585) ⭐ 102,140 | 🐛 8,959 | 📅 2026-09-04\
...
[webtty](https://github.com/maxmcd/webtty) ⭐ 2,811 | 🐛 18 | 🌐 Go | 📅 2024-12-11\
...
[Night-Reading-Go](https://github.com/developer-learning/night-reading-go) ⭐ 12,290 | 🐛 14 | 🌐 Go | 📅 2026-07-21\
...
[bat](https://github.com/sharkdp/bat) ⭐ 60,387 | 🐛 498 | 🌐 Rust | 📅 2026-09-04\
...
[node best practices](https://github.com/i0natan/nodebestpractices) ⭐ 105,612 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15\
一个收集  Node 最佳实践的仓库。
...
[Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days) ⭐ 186,101 | 🐛 715 | 🌐 Jupyter Notebook | 📅 2026-07-29\
一本针对初学者的 Python 教程。
...
[gov-takedowns](https://github.com/github/gov-takedowns) ⭐ 3,182 | 🐛 0 | 📅 2026-08-18\
