...
* 非常感谢阮一峰老师的[科技爱好者周刊](https://github.com/ruanyf/weekly) ⭐ 102,374 | 🐛 9,030 | 📅 2026-09-11提供的分享
...
[openpilot](https://github.com/commaai/openpilot) ⭐ 63,638 | 🐛 153 | 🌐 Python | 📅 2026-09-12\
...
[Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,383 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17\
...
[Clone Wars](https://github.com/GorvGoyl/Clone-Wars) ⭐ 36,745 | 🐛 40 | 📅 2024-08-06\
...
[Bing Wallpaper](https://github.com/niumoo/bing-wallpaper) ⭐ 3,713 | 🐛 3 | 🌐 Java | 📅 2026-09-12\
...
[Build your own x](https://github.com/danistefanovic/build-your-own-x) ⭐ 546,731 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14\
这个仓库专门收集各种教程，教你如何自己实现各种软件，比如 Web 服务器、BT 下载客户端、Git、数据库等等。

[Remark42](https://github.com/umputun/remark42) ⭐ 5,610 | 🐛 86 | 🌐 Go | 📅 2026-09-09\
![](https://www.wangbase.com/blogimg/asset/202102/bg2021020710.jpg)\
一个开源的、可以自己搭建的网站留言服务。

[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,278 | 🐛 159 | 🌐 Python | 📅 2026-09-11\
...
[hackernews-daily](https://github.com/headllines/hackernews-daily) ⭐ 690 | 🐛 2,236 | 🌐 JavaScript | 📅 2024-01-19\
...
[EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,987 | 🐛 530 | 🌐 Python | 📅 2025-12-05\
...
[monica](https://github.com/monicahq/monica) ⭐ 25,272 | 🐛 795 | 🌐 PHP | 📅 2026-04-24\
...
[awesome-qrcode](https://github.com/ruanyf/weekly/issues/795) ⭐ 102,374 | 🐛 9,030 | 📅 2026-09-11\
...
[you-get](https://github.com/soimort/you-get) ⭐ 56,881 | 🐛 386 | 🌐 Python | 📅 2026-08-24\
...
[字体裁剪工具](https://github.com/2234839/web-font) ⭐ 296 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-11\
...
[jimp](https://github.com/oliver-moran/jimp) ⭐ 14,663 | 🐛 187 | 🌐 TypeScript | 📅 2026-04-07\
...
[arwes](https://github.com/arwesjs/arwes) ⭐ 7,556 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-05\
![](https://www.wangbase.com/blogimg/asset/201811/bg2018110921.jpg)\
一个质量不错的科幻风格 React UI 组件库。

[retejs](https://github.com/retejs/rete) ⭐ 12,245 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24\
...
[JavaScript 算法与数据结构](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md) ⭐ 196,685 | 🐛 405 | 🌐 JavaScript | 📅 2026-07-26\
...
[css-protips](https://github.com/AllThingsSmitty/css-protips/tree/master/translations/zh-CN) ⭐ 30,270 | 🐛 1 | 📅 2026-08-24\
一个收集 CSS 使用技巧的库。
...
[bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) ⭐ 9,216 | 🐛 717 | 🌐 JavaScript | 📅 2026-09-11\
...
[kutt](https://github.com/thedevs-network/kutt) ⭐ 11,091 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-03\
开源的短链接生成器，基于 Node.js，允许自定义短链接、设置链接密码，还提供访问统计。

[snapdrop](https://github.com/RobinLinus/snapdrop) ⭐ 19,724 | 🐛 287 | 🌐 JavaScript | 📅 2025-02-10\
一个开源的文件分享服务，使用 WebRTC 协议进行点对点传输。

[tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,694 | 🐛 50 | 🌐 JavaScript | 📅 2026-05-17\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019062823.jpg)\
一个可以完成 62 种语言 OCR （光学识别）的 JS 库。

[如何使用 GitHub issue 作为博客后端？](https://github.com/ruanyf/weekly/issues/585) ⭐ 102,374 | 🐛 9,030 | 📅 2026-09-11\
...
[bat](https://github.com/sharkdp/bat) ⭐ 60,427 | 🐛 515 | 🌐 Rust | 📅 2026-09-04\
...
[Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days) ⭐ 186,348 | 🐛 716 | 🌐 Jupyter Notebook | 📅 2026-07-29\
一本针对初学者的 Python 教程。
...
这是很久以来，我见过的最酷主页，整个页面都是 3D 的。[页面源码](https://github.com/brunosimon/folio-2019) ⭐ 4,741 | 🐛 40 | 🌐 JavaScript | 📅 2024-05-25是开源的。
