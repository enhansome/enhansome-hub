...
* 非常感谢阮一峰老师的[科技爱好者周刊](https://github.com/ruanyf/weekly) ⭐ 101,892 | 🐛 8,907 | 📅 2026-08-28提供的分享
...
[openpilot](https://github.com/commaai/openpilot) ⭐ 63,559 | 🐛 136 | 🌐 Python | 📅 2026-09-03\
...
[Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,333 | 🐛 123 | 🌐 Jupyter Notebook | 📅 2024-08-17\
...
[chinese-xinhua](https://github.com/pwxcoo/chinese-xinhua) ⭐ 11,670 | 🐛 38 | 🌐 Python | 📅 2023-12-26\
...
[github-contributions-chart](https://github.com/sallar/github-contributions-chart) ⭐ 5,606 | 🐛 34 | 🌐 JavaScript | 📅 2025-02-20（[Demo](https://github-contributions.now.sh/)）\
GitHub 用户主页有一张图，每一天就是一个小格子。你只要在这一天提交了代码，这个格子就是绿色。但是，这张图只显示过去的一年，即365个格子。\
这个工具可以生成从你加入 GitHub 那天起的所有格子。

[rebound](https://github.com/shobrook/rebound) ⭐ 4,112 | 🐛 24 | 🌐 Python | 📅 2022-02-16\
...
[read-aloud](https://github.com/ken107/read-aloud) ⭐ 1,738 | 🐛 134 | 🌐 JavaScript | 📅 2026-07-10
...
[Clone Wars](https://github.com/GorvGoyl/Clone-Wars) ⭐ 36,712 | 🐛 40 | 📅 2024-08-06\
...
[Bing Wallpaper](https://github.com/niumoo/bing-wallpaper) ⭐ 3,703 | 🐛 4 | 🌐 Java | 📅 2026-09-03\
...
[Build your own x](https://github.com/danistefanovic/build-your-own-x) ⭐ 544,963 | 🐛 640 | 🌐 Markdown | 📅 2026-07-14\
这个仓库专门收集各种教程，教你如何自己实现各种软件，比如 Web 服务器、BT 下载客户端、Git、数据库等等。

[Remark42](https://github.com/umputun/remark42) ⭐ 5,602 | 🐛 108 | 🌐 Go | 📅 2026-09-03\
![](https://www.wangbase.com/blogimg/asset/202102/bg2021020710.jpg)\
一个开源的、可以自己搭建的网站留言服务。

[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,231 | 🐛 160 | 🌐 Python | 📅 2026-09-03\
...
[hackernews-daily](https://github.com/headllines/hackernews-daily) ⭐ 690 | 🐛 2,227 | 🌐 JavaScript | 📅 2024-01-19\
...
[EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,966 | 🐛 530 | 🌐 Python | 📅 2025-12-05\
...
一个点对点的文件在线传输工具，利用 Webrtc 在两台电脑之间建立直接连接，代码[开源](https://github.com/saljam/webwormhole) ⭐ 2,084 | 🐛 13 | 🌐 Go | 📅 2025-12-22。
...
[monica](https://github.com/monicahq/monica) ⭐ 25,218 | 🐛 794 | 🌐 PHP | 📅 2026-04-24\
...
[awesome-qrcode](https://github.com/ruanyf/weekly/issues/795) ⭐ 101,892 | 🐛 8,907 | 📅 2026-08-28\
二维码生成工具，可以生成静态二维码、图像二维码和动画二维码。

[Rough.js](https://github.com/pshihn/rough/) ⭐ 21,152 | 🐛 42 | 🌐 HTML | 📅 2024-07-28\
...
[TagUI-Python](https://github.com/tebelorg/TagUI-Python) ⭐ 5,495 | 🐛 4 | 🌐 Python | 📅 2026-07-25\
...
[OpenCC](https://github.com/BYVoid/OpenCC) ⭐ 9,958 | 🐛 50 | 🌐 C++ | 📅 2026-08-26\
...
[Feature Icons](https://github.com/feathericons/feather) ⭐ 25,989 | 🐛 511 | 🌐 JavaScript | 📅 2025-03-11\
一个开源图标库，提供一些简单漂亮的常用图标。

## 前端 <a name="frontend"></a>

[elevator.js](https://github.com/tholman/elevator.js) ⭐ 6,637 | 🐛 19 | 🌐 JavaScript | 📅 2020-06-26\
...
[PaperCSS](https://github.com/papercss/papercss) ⭐ 4,192 | 🐛 37 | 🌐 SCSS | 📅 2025-07-31\
...
[jimp](https://github.com/oliver-moran/jimp) ⭐ 14,667 | 🐛 187 | 🌐 TypeScript | 📅 2026-04-07\
...
[ImmortalDB](https://github.com/gruns/ImmortalDB) ⭐ 3,058 | 🐛 39 | 🌐 JavaScript | 📅 2025-04-18\
...
[retejs](https://github.com/retejs/rete) ⭐ 12,230 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24\
...
[react-particle-effect-button](https://github.com/transitive-bullshit/react-particle-effect-button) ⭐ 1,506 | 🐛 5 | 🌐 JavaScript | 📅 2023-10-26\
...
[JavaScript 算法与数据结构](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md) ⭐ 196,601 | 🐛 403 | 🌐 JavaScript | 📅 2026-07-26\
...
[css-protips](https://github.com/AllThingsSmitty/css-protips/tree/master/translations/zh-CN) ⭐ 30,262 | 🐛 1 | 📅 2026-08-24\
一个收集 CSS 使用技巧的库。

[img-2](https://github.com/RevillWeb/img-2) ⭐ 1,880 | 🐛 7 | 🌐 HTML | 📅 2018-05-22\
...
[bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) ⭐ 9,207 | 🐛 716 | 🌐 JavaScript | 📅 2026-09-03\
...
[kutt](https://github.com/thedevs-network/kutt) ⭐ 11,067 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-03\
开源的短链接生成器，基于 Node.js，允许自定义短链接、设置链接密码，还提供访问统计。

[snapdrop](https://github.com/RobinLinus/snapdrop) ⭐ 19,702 | 🐛 286 | 🌐 JavaScript | 📅 2025-02-10\
一个开源的文件分享服务，使用 WebRTC 协议进行点对点传输。

[tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,687 | 🐛 49 | 🌐 JavaScript | 📅 2026-05-17\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019062823.jpg)\
一个可以完成 62 种语言 OCR （光学识别）的 JS 库。

[如何使用 GitHub issue 作为博客后端？](https://github.com/ruanyf/weekly/issues/585) ⭐ 101,892 | 🐛 8,907 | 📅 2026-08-28\
...
[Night-Reading-Go](https://github.com/developer-learning/night-reading-go) ⭐ 12,288 | 🐛 14 | 🌐 Go | 📅 2026-07-21\
...
[bat](https://github.com/sharkdp/bat) ⭐ 60,363 | 🐛 423 | 🌐 Rust | 📅 2026-09-01\
...
[CycleGAN](https://github.com/junyanz/CycleGAN) ⭐ 12,869 | 🐛 59 | 🌐 Lua | 📅 2023-09-12\
...
[faceai](https://github.com/vipstone/faceai) ⭐ 11,079 | 🐛 38 | 🌐 Python | 📅 2020-04-16\
一款入门级的人脸、视频、文字检测以及识别的项目。

[机器学习50个最佳免费数据集](https://gengo.ai/articles/the-50-best-free-datasets-for-machine-learning/)\
这里列出50个可以用来训练模型的免费大型数据集。

[self-driving-toy-car](https://github.com/experiencor/self-driving-toy-car) ⭐ 521 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2017-07-28\
...
[node best practices](https://github.com/i0natan/nodebestpractices) ⭐ 105,603 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15\
一个收集  Node 最佳实践的仓库。
...
[Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days) ⭐ 185,889 | 🐛 715 | 🌐 Jupyter Notebook | 📅 2026-07-29\
一本针对初学者的 Python 教程。
...
这是很久以来，我见过的最酷主页，整个页面都是 3D 的。[页面源码](https://github.com/brunosimon/folio-2019) ⭐ 4,737 | 🐛 40 | 🌐 JavaScript | 📅 2024-05-25是开源的。
...
[Google CTF 的试题](https://github.com/google/google-ctf) ⭐ 5,019 | 🐛 1 | 🌐 Python | 📅 2026-02-11\
