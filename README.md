...
* 非常感谢阮一峰老师的[科技爱好者周刊](https://github.com/ruanyf/weekly) ⭐ 100,903 | 🐛 8,761 | 📅 2026-08-21提供的分享
...
[openpilot](https://github.com/commaai/openpilot) ⭐ 63,464 | 🐛 124 | 🌐 Python | 📅 2026-08-21\
...
[Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,273 | 🐛 123 | 🌐 Jupyter Notebook | 📅 2024-08-17\
...
[read-aloud](https://github.com/ken107/read-aloud) ⭐ 1,729 | 🐛 133 | 🌐 JavaScript | 📅 2026-07-10
...
[Clone Wars](https://github.com/GorvGoyl/Clone-Wars) ⭐ 36,418 | 🐛 38 | 📅 2024-08-06\
...
[Bing Wallpaper](https://github.com/niumoo/bing-wallpaper) ⭐ 3,675 | 🐛 4 | 🌐 Java | 📅 2026-08-21\
...
[Build your own x](https://github.com/danistefanovic/build-your-own-x) ⭐ 541,737 | 🐛 635 | 🌐 Markdown | 📅 2026-07-14\
这个仓库专门收集各种教程，教你如何自己实现各种软件，比如 Web 服务器、BT 下载客户端、Git、数据库等等。

[Remark42](https://github.com/umputun/remark42) ⭐ 5,583 | 🐛 88 | 🌐 Go | 📅 2026-08-21\
![](https://www.wangbase.com/blogimg/asset/202102/bg2021020710.jpg)\
一个开源的、可以自己搭建的网站留言服务。

[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,151 | 🐛 171 | 🌐 Python | 📅 2026-08-19\
...
[hackernews-daily](https://github.com/headllines/hackernews-daily) ⭐ 689 | 🐛 2,214 | 🌐 JavaScript | 📅 2024-01-19\
...
[EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,929 | 🐛 530 | 🌐 Python | 📅 2025-12-05\
...
[monica](https://github.com/monicahq/monica) ⭐ 25,077 | 🐛 792 | 🌐 PHP | 📅 2026-04-24\
...
[awesome-qrcode](https://github.com/ruanyf/weekly/issues/795) ⭐ 100,903 | 🐛 8,761 | 📅 2026-08-21\
二维码生成工具，可以生成静态二维码、图像二维码和动画二维码。

[Rough.js](https://github.com/pshihn/rough/) ⭐ 21,137 | 🐛 42 | 🌐 HTML | 📅 2024-07-28\
...
[OpenCC](https://github.com/BYVoid/OpenCC) ⭐ 9,926 | 🐛 50 | 🌐 C++ | 📅 2026-08-20\
...
[ReLaXed](https://github.com/RelaxedJS/ReLaXed) ⭐ 11,799 | 🐛 52 | 🌐 JavaScript | 📅 2025-09-07\
...
[Feature Icons](https://github.com/feathericons/feather) ⭐ 25,979 | 🐛 511 | 🌐 JavaScript | 📅 2025-03-11\
...
[JavaScript 算法与数据结构](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md) ⭐ 196,525 | 🐛 405 | 🌐 JavaScript | 📅 2026-07-26\
...
[css-protips](https://github.com/AllThingsSmitty/css-protips/tree/master/translations/zh-CN) ⭐ 30,253 | 🐛 2 | 📅 2025-03-20\
一个收集 CSS 使用技巧的库。
...
[bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) ⭐ 9,196 | 🐛 725 | 🌐 JavaScript | 📅 2026-08-21\
...
[kutt](https://github.com/thedevs-network/kutt) ⭐ 11,041 | 🐛 80 | 🌐 JavaScript | 📅 2026-08-17\
...
[tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,645 | 🐛 47 | 🌐 JavaScript | 📅 2026-05-17\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019062823.jpg)\
一个可以完成 62 种语言 OCR （光学识别）的 JS 库。

[如何使用 GitHub issue 作为博客后端？](https://github.com/ruanyf/weekly/issues/585) ⭐ 100,903 | 🐛 8,761 | 📅 2026-08-21\
...
[bat](https://github.com/sharkdp/bat) ⭐ 60,230 | 🐛 423 | 🌐 Rust | 📅 2026-08-11\
...
[node best practices](https://github.com/i0natan/nodebestpractices) ⭐ 105,595 | 🐛 137 | 🌐 Dockerfile | 📅 2026-06-15\
一个收集  Node 最佳实践的仓库。
...
[Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days) ⭐ 185,462 | 🐛 705 | 🌐 Jupyter Notebook | 📅 2026-07-29\
一本针对初学者的 Python 教程。
