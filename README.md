...
* 非常感谢阮一峰老师的[科技爱好者周刊](https://github.com/ruanyf/weekly) ⭐ 102,255 | 🐛 9,003 | 📅 2026-09-08提供的分享
...
[openpilot](https://github.com/commaai/openpilot) ⭐ 63,613 | 🐛 151 | 🌐 Python | 📅 2026-09-09\
...
[Depix](https://github.com/beurtschipper/Depix) ⚠️ Archived\
...
[Youka](https://github.com/youkaclub/youka-desktop/blob/master/README.md) ⭐ 461 | 🐛 0 | 📅 2020-10-25\
...
[pose-animator](https://github.com/yemount/pose-animator) ⭐ 8,852 | 🐛 51 | 🌐 JavaScript | 📅 2024-05-20\
![](https://www.wangbase.com/blogimg/asset/202005/bg2020052108.jpg)\
一个浏览器 JS 库，通过摄像头，实时捕捉用户的动作，生成 2D 动画。

[avatarify](https://github.com/alievk/avatarify) ⭐ 16,521 | 🐛 318 | 🌐 Python | 📅 2024-08-30\
...
[cats-of-jasnah](https://github.com/countable/cats-of-jasnah) ⭐ 198 | 🐛 1 | 🌐 JavaScript | 📅 2023-07-09\
...
[诺基亚短信图片生成器](https://github.com/dcalsky/zzkia) ⭐ 1,471 | 🐛 12 | 🌐 JavaScript | 📅 2025-06-08\
...
[drinkNow](https://github.com/sologgfun/drinkNow) ⭐ 132 | 🐛 3 | 🌐 HTML | 📅 2019-09-07\
...
[Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,372 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17\
![](https://www.wangbase.com/blogimg/asset/201908/bg2019081503.jpg)\
实时提升卡通动画的分辨率，使其成为高清动画的工具。

[996.Blockchain](https://github.com/996BC/996.Blockchain) ⚠️ Archived\
一个区块链项目，专门用于保存加班记录，用户可以把自己的加班记录存到区块链。

[Never-Blink](https://github.com/ByronHsu/Never-Blink) ⭐ 900 | 🐛 7 | 🌐 JavaScript | 📅 2022-11-22\
...
[JSCity](https://github.com/aserg-ufmg/JSCity) ⭐ 1,400 | 🐛 4 | 🌐 JavaScript | 📅 2019-11-03\
![](https://www.wangbase.com/blogimg/asset/201811/bg2018113019.jpg)\
该工具可以将 JS 项目的源代码显示为一座城市。还有一个类似的[项目](https://github.com/rodrigo-brito/gocity) ⭐ 1,807 | 🐛 10 | 🌐 Go | 📅 2025-12-05，专用于 Go 语言。
...
[chinese-xinhua](https://github.com/pwxcoo/chinese-xinhua) ⭐ 11,675 | 🐛 38 | 🌐 Python | 📅 2023-12-26\
新华字典数据库和 API，收录 14032 条歇后语，16142 个汉字，264434 个词语，31648 个成语。

[cartoonify](https://github.com/danmacnish/cartoonify) ⭐ 2,051 | 🐛 28 | 🌐 Python | 📅 2022-12-07\
...
[如何在抖音上找到漂亮小姐姐？](https://github.com/wangshub/Douyin-Bot) ⭐ 9,634 | 🐛 65 | 🌐 Python | 📅 2023-10-03\
...
[github-contributions-chart](https://github.com/sallar/github-contributions-chart) ⭐ 5,608 | 🐛 34 | 🌐 JavaScript | 📅 2025-02-20（[Demo](https://github-contributions.now.sh/)）\
GitHub 用户主页有一张图，每一天就是一个小格子。你只要在这一天提交了代码，这个格子就是绿色。但是，这张图只显示过去的一年，即365个格子。\
这个工具可以生成从你加入 GitHub 那天起的所有格子。

[rebound](https://github.com/shobrook/rebound) ⭐ 4,114 | 🐛 24 | 🌐 Python | 📅 2022-02-16\
![](http://www.ruanyifeng.com/blogimg/asset/2018/bg2018042812.jpg)\
有人终于把这个工具写出来了，一旦 Python 或 JS 脚本报错，就到 Stack Overflow 取回报错信息的解释。

[Remote Browser](https://github.com/intoli/remote-browser) ⭐ 1,750 | 🐛 8 | 🌐 JavaScript | 📅 2018-07-14\
一个浏览器自动化框架，可以用脚本控制已经打开的浏览器。

## 效率 <a name="good"></a>

[read-aloud](https://github.com/ken107/read-aloud) ⭐ 1,740 | 🐛 134 | 🌐 JavaScript | 📅 2026-07-10
...
[push-bot](https://github.com/tans/push-bot) ⭐ 375 | 🐛 2 | 🌐 JavaScript | 📅 2022-12-06\
...
[Clone Wars](https://github.com/GorvGoyl/Clone-Wars) ⭐ 36,733 | 🐛 40 | 📅 2024-08-06\
...
[Bing Wallpaper](https://github.com/niumoo/bing-wallpaper) ⭐ 3,713 | 🐛 3 | 🌐 Java | 📅 2026-09-09\
![](https://cdn.beekka.com/blogimg/asset/202103/bg2021030307.jpg)\
这个项目使用 GitHub Actions，收集 Bing 搜索引擎每天的壁纸，提供下载，

[pcp](https://github.com/dennis-tra/pcp) ⚠️ Archived\
一个命令行的点对点文件传输软件，用法非常简单。一个命令上传文件，然后返回一个接收码，另一台电脑使用接收码接收文件。

[视频的自然语言搜索](https://github.com/haltakov/natural-language-youtube-search) ⭐ 935 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2021-10-15\
...
[Build your own x](https://github.com/danistefanovic/build-your-own-x) ⭐ 546,187 | 🐛 641 | 🌐 Markdown | 📅 2026-07-14\
这个仓库专门收集各种教程，教你如何自己实现各种软件，比如 Web 服务器、BT 下载客户端、Git、数据库等等。

[Remark42](https://github.com/umputun/remark42) ⭐ 5,607 | 🐛 86 | 🌐 Go | 📅 2026-09-09\
![](https://www.wangbase.com/blogimg/asset/202102/bg2021020710.jpg)\
一个开源的、可以自己搭建的网站留言服务。

[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,257 | 🐛 159 | 🌐 Python | 📅 2026-09-07\
...
[imgdiff](https://github.com/n7olkachev/imgdiff) ⭐ 1,706 | 🐛 2 | 🌐 Go | 📅 2021-03-25\
比较两张图片差异的命令行工具。
...
[real-live](https://github.com/parzulpan/real-live) ⭐ 1,064 | 🐛 1 | 🌐 Java | 📅 2023-05-22\
...
[hackernews-daily](https://github.com/headllines/hackernews-daily) ⭐ 690 | 🐛 2,233 | 🌐 JavaScript | 📅 2024-01-19\
...
[snapcode](https://github.com/sergeichestakov/snapcode) ⭐ 162 | 🐛 13 | 🌐 TypeScript | 📅 2023-03-05\
...
[EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,986 | 🐛 530 | 🌐 Python | 📅 2025-12-05\
...
一个点对点的文件在线传输工具，利用 Webrtc 在两台电脑之间建立直接连接，代码[开源](https://github.com/saljam/webwormhole) ⭐ 2,086 | 🐛 13 | 🌐 Go | 📅 2025-12-22。

[endpoints.dev](https://www.endpoints.dev/)\
该网站向每个用户提供一个独特的 API 终点（endpoint），用于接受 HTTP 请求。用户发来的所有请求，都可以在该网站实时显示，用于调试和记录。

[droppy](https://github.com/silverwind/droppy) ⚠️ Archived\
...
[monica](https://github.com/monicahq/monica) ⭐ 25,256 | 🐛 795 | 🌐 PHP | 📅 2026-04-24\
...
[划词二维码](https://github.com/tanghuibo/qrcode-chrome-plug-in) ⭐ 50 | 🐛 20 | 🌐 Vue | 📅 2022-12-11\
Chrome 浏览器插件，为选中的文字生成二维码，可以用来为网页提到的网址生成二维码。

[scoper](https://github.com/RameshAditya/scoper) ⭐ 268 | 🐛 6 | 🌐 Python | 📅 2022-12-08\
...
[awesome-qrcode](https://github.com/ruanyf/weekly/issues/795) ⭐ 102,255 | 🐛 9,003 | 📅 2026-09-08\
二维码生成工具，可以生成静态二维码、图像二维码和动画二维码。

[Rough.js](https://github.com/pshihn/rough/) ⭐ 21,161 | 🐛 42 | 🌐 HTML | 📅 2024-07-28\
...
[TagUI-Python](https://github.com/tebelorg/TagUI-Python) ⭐ 5,496 | 🐛 4 | 🌐 Python | 📅 2026-07-25\
...
[you-get](https://github.com/soimort/you-get) ⭐ 56,880 | 🐛 386 | 🌐 Python | 📅 2026-08-24\
You-Get 一小小哒命令行程序，提供便利的方式来下载近乎全网的视频。

[Squoosh](https://squoosh.app/)\
谷歌推出的图像压缩工具，代码开源。官网可以在线压缩图片，而且可以转换图片格式（比如 webp 转 jpg）。

[twitter2facebook](https://github.com/gslin/twitter2facebook) ⚠️ Archived\
...
[strapdown](https://github.com/arturadib/strapdown) ⭐ 2,461 | 🐛 64 | 🌐 JavaScript | 📅 2018-06-15\
...
[OpenCC](https://github.com/BYVoid/OpenCC) ⭐ 9,970 | 🐛 53 | 🌐 C++ | 📅 2026-08-26\
中文繁体和简体互相转换的开源工具，C 语言开发的。

[camelot](https://github.com/socialcopsdev/camelot) ⚠️ Archived\
从 PDF 文件（非扫描）里面提取表格的 Python 库。

[ytdl-webserver](https://github.com/Algram/ytdl-webserver) ⭐ 1,444 | 🐛 42 | 🌐 JavaScript | 📅 2023-02-22\
![](https://www.wangbase.com/blogimg/asset/201810/bg2018100521.jpg)\
搭建 Web 服务下载 Youtube 视频的工具。

[reminiscence](https://github.com/kanishka-linux/reminiscence) ⭐ 1,855 | 🐛 27 | 🌐 JavaScript | 📅 2024-04-23\
...
[ReLaXed](https://github.com/RelaxedJS/ReLaXed) ⭐ 11,796 | 🐛 52 | 🌐 JavaScript | 📅 2025-09-07\
...
[Feature Icons](https://github.com/feathericons/feather) ⭐ 25,990 | 🐛 510 | 🌐 JavaScript | 📅 2025-03-11\
一个开源图标库，提供一些简单漂亮的常用图标。

## 前端 <a name="frontend"></a>

[elevator.js](https://github.com/tholman/elevator.js) ⭐ 6,638 | 🐛 19 | 🌐 JavaScript | 📅 2020-06-26\
...
[字体裁剪工具](https://github.com/2234839/web-font) ⭐ 296 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02\
...
[craft.js](https://github.com/prevwong/craft.js) ⭐ 8,738 | 🐛 227 | 🌐 TypeScript | 📅 2025-02-14\
...
[臆病な魔女](https://github.com/yui540/Cowardly-Witch) ⚠️ Archived\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019060101.jpg)\
一个具有非常酷炫动画的日本动漫网站，代码开源。

[PaperCSS](https://github.com/papercss/papercss) ⭐ 4,193 | 🐛 37 | 🌐 SCSS | 📅 2025-07-31\
...
[jimp](https://github.com/oliver-moran/jimp) ⭐ 14,664 | 🐛 187 | 🌐 TypeScript | 📅 2026-04-07\
一个 Node.js 的图像处理库，为图像加特效。

[send](https://github.com/mozilla/send) ⚠️ Archived\
Mozilla 的文件上传服务 send.firefox.com 的源码，基于 Nodejs。

[Maze\_Solver\_Generator](https://github.com/dmaydan/Maze_Solver_Generator) ⭐ 202 | 🐛 1 | 🌐 JavaScript | 📅 2019-07-28\
![](https://www.wangbase.com/blogimg/asset/201903/bg2019030819.jpg)\
一个在 \<canvas> 元素上绘制和解决迷宫的 JavaScript 库。

[ImmortalDB](https://github.com/gruns/ImmortalDB) ⭐ 3,057 | 🐛 39 | 🌐 JavaScript | 📅 2025-04-18\
...
[arwes](https://github.com/arwesjs/arwes) ⭐ 7,557 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-05\
![](https://www.wangbase.com/blogimg/asset/201811/bg2018110921.jpg)\
一个质量不错的科幻风格 React UI 组件库。

[retejs](https://github.com/retejs/rete) ⭐ 12,240 | 🐛 14 | 🌐 TypeScript | 📅 2026-07-24\
...
[react-particle-effect-button](https://github.com/transitive-bullshit/react-particle-effect-button) ⭐ 1,505 | 🐛 5 | 🌐 JavaScript | 📅 2023-10-26\
![](https://www.wangbase.com/blogimg/asset/201808/bg2018081720.jpg)\
一个 React 组件，按钮点击后会像粒子状消解。

[wired-elements](https://github.com/wiredjs/wired-elements) ⭐ 10,825 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07\
...
[JavaScript 算法与数据结构](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md) ⭐ 196,666 | 🐛 404 | 🌐 JavaScript | 📅 2026-07-26\
...
[css-protips](https://github.com/AllThingsSmitty/css-protips/tree/master/translations/zh-CN) ⭐ 30,267 | 🐛 1 | 📅 2026-08-24\
一个收集 CSS 使用技巧的库。

[img-2](https://github.com/RevillWeb/img-2) ⭐ 1,878 | 🐛 7 | 🌐 HTML | 📅 2018-05-22\
...
[script-httpd](https://github.com/beefsack/script-httpd/) ⭐ 961 | 🐛 0 | 🌐 Go | 📅 2020-09-27\
...
[spiderman](https://github.com/TurboWay/spiderman) ⭐ 613 | 🐛 7 | 🌐 Python | 📅 2023-03-31\
...
[bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) ⭐ 9,216 | 🐛 720 | 🌐 JavaScript | 📅 2026-09-09\
...
[kutt](https://github.com/thedevs-network/kutt) ⭐ 11,085 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-03\
开源的短链接生成器，基于 Node.js，允许自定义短链接、设置链接密码，还提供访问统计。

[snapdrop](https://github.com/RobinLinus/snapdrop) ⭐ 19,717 | 🐛 287 | 🌐 JavaScript | 📅 2025-02-10\
一个开源的文件分享服务，使用 WebRTC 协议进行点对点传输。

[tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,695 | 🐛 49 | 🌐 JavaScript | 📅 2026-05-17\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019062823.jpg)\
一个可以完成 62 种语言 OCR （光学识别）的 JS 库。

[如何使用 GitHub issue 作为博客后端？](https://github.com/ruanyf/weekly/issues/585) ⭐ 102,255 | 🐛 9,003 | 📅 2026-09-08\
...
[webtty](https://github.com/maxmcd/webtty) ⭐ 2,810 | 🐛 18 | 🌐 Go | 📅 2024-12-11\
...
[pygmy](https://github.com/amitt001/pygmy) ⭐ 728 | 🐛 18 | 🌐 Python | 📅 2024-03-07\
...
[Night-Reading-Go](https://github.com/developer-learning/night-reading-go) ⭐ 12,289 | 🐛 14 | 🌐 Go | 📅 2026-07-21\
...
[bat](https://github.com/sharkdp/bat) ⭐ 60,390 | 🐛 514 | 🌐 Rust | 📅 2026-09-04\
...
[Post-Pages-to-IPFS](https://github.com/SaltyLeo/Post-Pages-to-IPFS) ⭐ 98 | 🐛 0 | 🌐 HTML | 📅 2021-11-10\
...
[IPFS 教程](https://github.com/miaoski/ipfs-tutorial) ⭐ 495 | 🐛 1 | 🌐 JavaScript | 📅 2018-09-21\
...
[video-object-removal](https://github.com/zllrunning/video-object-removal) ⭐ 2,710 | 🐛 34 | 🌐 Python | 📅 2019-09-27\
![](https://www.wangbase.com/blogimg/asset/201907/bg2019071804.jpg)\
这个工具使用机器学习算法，去除视频里面的运动物体。

[sketch-code](https://github.com/ashnkumar/sketch-code) ⭐ 5,143 | 🐛 29 | 🌐 Python | 📅 2026-08-06\
...
[CycleGAN](https://github.com/junyanz/CycleGAN) ⭐ 12,870 | 🐛 59 | 🌐 Lua | 📅 2023-09-12\
![](https://www.wangbase.com/blogimg/asset/201812/bg2018121424.jpg)\
图像处理软件，可以把马变成斑马、苹果变成橙子。

[DeOldify](https://github.com/jantic/DeOldify) ⚠️ Archived\
...
[TensorFlow-Course](https://github.com/open-source-for-science/TensorFlow-Course) ⭐ 16,274 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2022-11-28\
针对新手的 TensorFlow 教程。

[lip-reading-deeplearning](https://github.com/astorfi/lip-reading-deeplearning) ⭐ 1,904 | 🐛 7 | 🌐 Python | 📅 2022-11-07\
![](https://www.wangbase.com/blogimg/asset/201811/bg2018110217.jpg)\
一个使用深度学习，从嘴唇变化识别语言的库。

[faceai](https://github.com/vipstone/faceai) ⭐ 11,082 | 🐛 38 | 🌐 Python | 📅 2020-04-16\
一款入门级的人脸、视频、文字检测以及识别的项目。

[机器学习50个最佳免费数据集](https://gengo.ai/articles/the-50-best-free-datasets-for-machine-learning/)\
这里列出50个可以用来训练模型的免费大型数据集。

[self-driving-toy-car](https://github.com/experiencor/self-driving-toy-car) ⭐ 522 | 🐛 1 | 🌐 Jupyter Notebook | 📅 2017-07-28\
![](https://www.wangbase.com/blogimg/asset/201806/bg2018060821.jpg)\
一个开源的自动驾驶玩具车，在小车上面绑了一个树莓派和摄像头。

## 免费教程资源 <a name="freebook"></a>

[Notion Clone](https://github.com/konstantinmuenster/notion-clone) ⭐ 2,955 | 🐛 9 | 🌐 JavaScript | 📅 2023-10-15
...
[node best practices](https://github.com/i0natan/nodebestpractices) ⭐ 105,608 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15\
一个收集  Node 最佳实践的仓库。
...
[Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days) ⭐ 186,208 | 🐛 716 | 🌐 Jupyter Notebook | 📅 2026-07-29\
一本针对初学者的 Python 教程。
...
[互联网公司技术架构](https://github.com/davideuler/architecture.of.internet-product) ⭐ 20,788 | 🐛 10 | 🌐 HTML | 📅 2024-02-17\
...
[Finger Pool](https://github.com/victorqribeiro/fingerPool) ⭐ 117 | 🐛 0 | 🌐 JavaScript | 📅 2021-02-27\
![](https://cdn.beekka.com/blogimg/asset/202102/bg2021022003.jpg)\
开源的 2D 网页桌球游戏，撞击效果做得很好。

[如何不靠运气变得富有](https://github.com/fat-garage/how-to-get-rich-without-getting-lucky) ⭐ 947 | 🐛 2 | 📅 2020-10-10（中文）\
...
[gov-takedowns](https://github.com/github/gov-takedowns) ⭐ 3,181 | 🐛 0 | 📅 2026-08-18\
...
这是很久以来，我见过的最酷主页，整个页面都是 3D 的。[页面源码](https://github.com/brunosimon/folio-2019) ⭐ 4,740 | 🐛 40 | 🌐 JavaScript | 📅 2024-05-25是开源的。
...
[Vialer-js](https://github.com/vialer/vialer-js) ⭐ 1,006 | 🐛 21 | 🌐 JavaScript | 📅 2019-03-13\
一个基于 WebRTC 技术的实时通讯平台，可以实现 P2P 的文字聊天、语音和视频对话。

[Google CTF 的试题](https://github.com/google/google-ctf) ⭐ 5,020 | 🐛 1 | 🌐 Python | 📅 2026-02-11\
...
[merge-images](https://github.com/lukechilds/merge-images) ⭐ 1,710 | 🐛 43 | 🌐 JavaScript | 📅 2026-05-17\
