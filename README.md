...
* 非常感谢阮一峰老师的[科技爱好者周刊](https://github.com/ruanyf/weekly) ⭐ 104,746 | 🐛 9,231 | 📅 2026-09-19提供的分享
...
[openpilot](https://github.com/commaai/openpilot) ⭐ 63,737 | 🐛 137 | 🌐 Python | 📅 2026-09-26\
...
[pose-animator](https://github.com/yemount/pose-animator) ⭐ 8,848 | 🐛 51 | 🌐 JavaScript | 📅 2024-05-20\
![](https://www.wangbase.com/blogimg/asset/202005/bg2020052108.jpg)\
一个浏览器 JS 库，通过摄像头，实时捕捉用户的动作，生成 2D 动画。

[avatarify](https://github.com/alievk/avatarify) ⭐ 16,521 | 🐛 319 | 🌐 Python | 📅 2024-08-30\
...
[cats-of-jasnah](https://github.com/countable/cats-of-jasnah) ⭐ 199 | 🐛 1 | 🌐 JavaScript | 📅 2023-07-09\
...
[诺基亚短信图片生成器](https://github.com/dcalsky/zzkia) ⭐ 1,470 | 🐛 12 | 🌐 JavaScript | 📅 2025-06-08\
...
[Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,432 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17\
...
该工具可以将 JS 项目的源代码显示为一座城市。还有一个类似的[项目](https://github.com/rodrigo-brito/gocity) ⭐ 1,810 | 🐛 10 | 🌐 Go | 📅 2025-12-05，专用于 Go 语言。
...
[chinese-xinhua](https://github.com/pwxcoo/chinese-xinhua) ⭐ 11,686 | 🐛 38 | 🌐 Python | 📅 2023-12-26\
...
[如何在抖音上找到漂亮小姐姐？](https://github.com/wangshub/Douyin-Bot) ⭐ 9,642 | 🐛 65 | 🌐 Python | 📅 2023-10-03\
...
[github-contributions-chart](https://github.com/sallar/github-contributions-chart) ⭐ 5,609 | 🐛 34 | 🌐 JavaScript | 📅 2025-02-20（[Demo](https://github-contributions.now.sh/)）\
...
[Remote Browser](https://github.com/intoli/remote-browser) ⭐ 1,751 | 🐛 8 | 🌐 JavaScript | 📅 2018-07-14\
一个浏览器自动化框架，可以用脚本控制已经打开的浏览器。

## 效率 <a name="good"></a>

[read-aloud](https://github.com/ken107/read-aloud) ⭐ 1,751 | 🐛 134 | 🌐 JavaScript | 📅 2026-09-24
...
[Clone Wars](https://github.com/GorvGoyl/Clone-Wars) ⭐ 36,822 | 🐛 41 | 📅 2024-08-06\
...
[Bing Wallpaper](https://github.com/niumoo/bing-wallpaper) ⭐ 3,739 | 🐛 3 | 🌐 Java | 📅 2026-09-26\
...
[Build your own x](https://github.com/danistefanovic/build-your-own-x) ⭐ 549,789 | 🐛 645 | 🌐 Markdown | 📅 2026-07-14\
这个仓库专门收集各种教程，教你如何自己实现各种软件，比如 Web 服务器、BT 下载客户端、Git、数据库等等。

[Remark42](https://github.com/umputun/remark42) ⭐ 5,613 | 🐛 89 | 🌐 Go | 📅 2026-09-14\
![](https://www.wangbase.com/blogimg/asset/202102/bg2021020710.jpg)\
一个开源的、可以自己搭建的网站留言服务。

[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,620 | 🐛 165 | 🌐 Python | 📅 2026-09-26\
...
[hackernews-daily](https://github.com/headllines/hackernews-daily) ⭐ 690 | 🐛 2,250 | 🌐 JavaScript | 📅 2024-01-19\
...
[EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 30,032 | 🐛 531 | 🌐 Python | 📅 2025-12-05\
...
一个点对点的文件在线传输工具，利用 Webrtc 在两台电脑之间建立直接连接，代码[开源](https://github.com/saljam/webwormhole) ⭐ 2,090 | 🐛 13 | 🌐 Go | 📅 2025-12-22。
...
[monica](https://github.com/monicahq/monica) ⭐ 25,366 | 🐛 791 | 🌐 PHP | 📅 2026-09-24\
...
[awesome-qrcode](https://github.com/ruanyf/weekly/issues/795) ⭐ 104,746 | 🐛 9,231 | 📅 2026-09-19\
二维码生成工具，可以生成静态二维码、图像二维码和动画二维码。

[Rough.js](https://github.com/pshihn/rough/) ⭐ 21,201 | 🐛 42 | 🌐 HTML | 📅 2024-07-28\
...
[TagUI-Python](https://github.com/tebelorg/TagUI-Python) ⭐ 5,501 | 🐛 4 | 🌐 Python | 📅 2026-07-25\
...
[you-get](https://github.com/soimort/you-get) ⭐ 56,874 | 🐛 386 | 🌐 Python | 📅 2026-08-24\
...
[OpenCC](https://github.com/BYVoid/OpenCC) ⭐ 10,011 | 🐛 52 | 🌐 C++ | 📅 2026-09-25\
...
[reminiscence](https://github.com/kanishka-linux/reminiscence) ⭐ 1,856 | 🐛 27 | 🌐 JavaScript | 📅 2024-04-23\
...
[Feature Icons](https://github.com/feathericons/feather) ⭐ 26,006 | 🐛 510 | 🌐 JavaScript | 📅 2025-03-11\
一个开源图标库，提供一些简单漂亮的常用图标。

## 前端 <a name="frontend"></a>

[elevator.js](https://github.com/tholman/elevator.js) ⭐ 6,635 | 🐛 19 | 🌐 JavaScript | 📅 2020-06-26\
...
[craft.js](https://github.com/prevwong/craft.js) ⭐ 8,751 | 🐛 227 | 🌐 TypeScript | 📅 2025-02-14\
...
[PaperCSS](https://github.com/papercss/papercss) ⭐ 4,189 | 🐛 38 | 🌐 SCSS | 📅 2025-07-31\
...
[jimp](https://github.com/oliver-moran/jimp) ⭐ 14,662 | 🐛 189 | 🌐 TypeScript | 📅 2026-04-07\
...
[ImmortalDB](https://github.com/gruns/ImmortalDB) ⭐ 3,056 | 🐛 39 | 🌐 JavaScript | 📅 2025-04-18\
...
[arwes](https://github.com/arwesjs/arwes) ⭐ 7,562 | 🐛 10 | 🌐 TypeScript | 📅 2026-07-05\
![](https://www.wangbase.com/blogimg/asset/201811/bg2018110921.jpg)\
一个质量不错的科幻风格 React UI 组件库。

[retejs](https://github.com/retejs/rete) ⭐ 12,275 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-13\
...
[react-particle-effect-button](https://github.com/transitive-bullshit/react-particle-effect-button) ⭐ 1,504 | 🐛 5 | 🌐 JavaScript | 📅 2023-10-26\
![](https://www.wangbase.com/blogimg/asset/201808/bg2018081720.jpg)\
一个 React 组件，按钮点击后会像粒子状消解。

[wired-elements](https://github.com/wiredjs/wired-elements) ⭐ 10,832 | 🐛 36 | 🌐 TypeScript | 📅 2023-10-07\
...
[JavaScript 算法与数据结构](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md) ⭐ 196,813 | 🐛 407 | 🌐 JavaScript | 📅 2026-07-26\
...
[css-protips](https://github.com/AllThingsSmitty/css-protips/tree/master/translations/zh-CN) ⭐ 30,285 | 🐛 1 | 📅 2026-09-23\
一个收集 CSS 使用技巧的库。
...
[script-httpd](https://github.com/beefsack/script-httpd/) ⭐ 962 | 🐛 0 | 🌐 Go | 📅 2020-09-27\
...
[spiderman](https://github.com/TurboWay/spiderman) ⭐ 614 | 🐛 7 | 🌐 Python | 📅 2023-03-31\
...
[bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) ⭐ 9,228 | 🐛 737 | 🌐 JavaScript | 📅 2026-09-26\
...
[kutt](https://github.com/thedevs-network/kutt) ⭐ 11,123 | 🐛 84 | 🌐 JavaScript | 📅 2026-09-03\
开源的短链接生成器，基于 Node.js，允许自定义短链接、设置链接密码，还提供访问统计。

[snapdrop](https://github.com/RobinLinus/snapdrop) ⭐ 29 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15\
一个开源的文件分享服务，使用 WebRTC 协议进行点对点传输。

[tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,738 | 🐛 53 | 🌐 JavaScript | 📅 2026-05-17\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019062823.jpg)\
一个可以完成 62 种语言 OCR （光学识别）的 JS 库。

[如何使用 GitHub issue 作为博客后端？](https://github.com/ruanyf/weekly/issues/585) ⭐ 104,746 | 🐛 9,231 | 📅 2026-09-19\
...
[webtty](https://github.com/maxmcd/webtty) ⭐ 2,813 | 🐛 18 | 🌐 Go | 📅 2024-12-11\
...
[Night-Reading-Go](https://github.com/developer-learning/night-reading-go) ⭐ 12,285 | 🐛 9 | 🌐 Go | 📅 2026-09-15\
...
[bat](https://github.com/sharkdp/bat) ⭐ 60,579 | 🐛 519 | 🌐 Rust | 📅 2026-09-22\
...
[video-object-removal](https://github.com/zllrunning/video-object-removal) ⭐ 2,713 | 🐛 34 | 🌐 Python | 📅 2019-09-27\
![](https://www.wangbase.com/blogimg/asset/201907/bg2019071804.jpg)\
这个工具使用机器学习算法，去除视频里面的运动物体。

[sketch-code](https://github.com/ashnkumar/sketch-code) ⭐ 5,142 | 🐛 29 | 🌐 Python | 📅 2026-08-06\
...
[CycleGAN](https://github.com/junyanz/CycleGAN) ⭐ 12,875 | 🐛 60 | 🌐 Lua | 📅 2023-09-12\
...
[TensorFlow-Course](https://github.com/open-source-for-science/TensorFlow-Course) ⭐ 16,269 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2022-11-28\
针对新手的 TensorFlow 教程。

[lip-reading-deeplearning](https://github.com/astorfi/lip-reading-deeplearning) ⭐ 1,901 | 🐛 7 | 🌐 Python | 📅 2022-11-07\
![](https://www.wangbase.com/blogimg/asset/201811/bg2018110217.jpg)\
一个使用深度学习，从嘴唇变化识别语言的库。

[faceai](https://github.com/vipstone/faceai) ⭐ 11,092 | 🐛 38 | 🌐 Python | 📅 2020-04-16\
...
[node best practices](https://github.com/i0natan/nodebestpractices) ⭐ 105,634 | 🐛 138 | 🌐 Dockerfile | 📅 2026-06-15\
一个收集  Node 最佳实践的仓库。
...
[Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days) ⭐ 186,905 | 🐛 715 | 🌐 Jupyter Notebook | 📅 2026-07-29\
一本针对初学者的 Python 教程。
...
[互联网公司技术架构](https://github.com/davideuler/architecture.of.internet-product) ⭐ 20,790 | 🐛 10 | 🌐 HTML | 📅 2024-02-17\
...
[gov-takedowns](https://github.com/github/gov-takedowns) ⭐ 3,181 | 🐛 0 | 📅 2026-09-10\
...
这是很久以来，我见过的最酷主页，整个页面都是 3D 的。[页面源码](https://github.com/brunosimon/folio-2019) ⭐ 4,748 | 🐛 40 | 🌐 JavaScript | 📅 2024-05-25是开源的。
...
[Vialer-js](https://github.com/vialer/vialer-js) ⭐ 1,005 | 🐛 21 | 🌐 JavaScript | 📅 2019-03-13\
一个基于 WebRTC 技术的实时通讯平台，可以实现 P2P 的文字聊天、语音和视频对话。

[Google CTF 的试题](https://github.com/google/google-ctf) ⭐ 5,028 | 🐛 1 | 🌐 Python | 📅 2026-09-15\
