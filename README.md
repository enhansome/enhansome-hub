...
* 非常感谢阮一峰老师的[科技爱好者周刊](https://github.com/ruanyf/weekly) ⭐ 102,754 | 🐛 9,122 | 📅 2026-09-13提供的分享
...
[openpilot](https://github.com/commaai/openpilot) ⭐ 63,671 | 🐛 143 | 🌐 Python | 📅 2026-09-17\
...
[Anime4K](https://github.com/bloc97/Anime4K) ⭐ 21,402 | 🐛 119 | 🌐 Jupyter Notebook | 📅 2024-08-17\
...
[chinese-xinhua](https://github.com/pwxcoo/chinese-xinhua) ⭐ 11,681 | 🐛 38 | 🌐 Python | 📅 2023-12-26\
...
[如何在抖音上找到漂亮小姐姐？](https://github.com/wangshub/Douyin-Bot) ⭐ 9,637 | 🐛 65 | 🌐 Python | 📅 2023-10-03\
...
[read-aloud](https://github.com/ken107/read-aloud) ⭐ 1,748 | 🐛 134 | 🌐 JavaScript | 📅 2026-07-10
...
[Clone Wars](https://github.com/GorvGoyl/Clone-Wars) ⭐ 36,764 | 🐛 40 | 📅 2024-08-06\
...
[Bing Wallpaper](https://github.com/niumoo/bing-wallpaper) ⭐ 3,722 | 🐛 3 | 🌐 Java | 📅 2026-09-17\
...
[Build your own x](https://github.com/danistefanovic/build-your-own-x) ⭐ 547,836 | 🐛 643 | 🌐 Markdown | 📅 2026-07-14\
这个仓库专门收集各种教程，教你如何自己实现各种软件，比如 Web 服务器、BT 下载客户端、Git、数据库等等。

[Remark42](https://github.com/umputun/remark42) ⭐ 5,612 | 🐛 89 | 🌐 Go | 📅 2026-09-14\
![](https://www.wangbase.com/blogimg/asset/202102/bg2021020710.jpg)\
一个开源的、可以自己搭建的网站留言服务。

[ArchiveBox](https://github.com/ArchiveBox/ArchiveBox) ⭐ 28,483 | 🐛 160 | 🌐 Python | 📅 2026-09-17\
...
[hackernews-daily](https://github.com/headllines/hackernews-daily) ⭐ 690 | 🐛 2,241 | 🌐 JavaScript | 📅 2024-01-19\
...
[EasyOCR](https://github.com/JaidedAI/EasyOCR) ⭐ 29,999 | 🐛 531 | 🌐 Python | 📅 2025-12-05\
...
[monica](https://github.com/monicahq/monica) ⭐ 25,322 | 🐛 795 | 🌐 PHP | 📅 2026-04-24\
...
[awesome-qrcode](https://github.com/ruanyf/weekly/issues/795) ⭐ 102,754 | 🐛 9,122 | 📅 2026-09-13\
二维码生成工具，可以生成静态二维码、图像二维码和动画二维码。

[Rough.js](https://github.com/pshihn/rough/) ⭐ 21,184 | 🐛 42 | 🌐 HTML | 📅 2024-07-28\
...
[TagUI-Python](https://github.com/tebelorg/TagUI-Python) ⭐ 5,499 | 🐛 4 | 🌐 Python | 📅 2026-07-25\
...
[OpenCC](https://github.com/BYVoid/OpenCC) ⭐ 9,985 | 🐛 51 | 🌐 C++ | 📅 2026-09-16\
...
[Feature Icons](https://github.com/feathericons/feather) ⭐ 25,996 | 🐛 510 | 🌐 JavaScript | 📅 2025-03-11\
...
[retejs](https://github.com/retejs/rete) ⭐ 12,261 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-13\
...
[JavaScript 算法与数据结构](https://github.com/trekhleb/javascript-algorithms/blob/master/README.zh-CN.md) ⭐ 196,754 | 🐛 406 | 🌐 JavaScript | 📅 2026-07-26\
...
[css-protips](https://github.com/AllThingsSmitty/css-protips/tree/master/translations/zh-CN) ⭐ 30,279 | 🐛 1 | 📅 2026-08-24\
一个收集 CSS 使用技巧的库。
...
[bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) ⭐ 9,219 | 🐛 725 | 🌐 JavaScript | 📅 2026-09-17\
...
[kutt](https://github.com/thedevs-network/kutt) ⭐ 11,107 | 🐛 83 | 🌐 JavaScript | 📅 2026-09-03\
开源的短链接生成器，基于 Node.js，允许自定义短链接、设置链接密码，还提供访问统计。

[snapdrop](https://github.com/RobinLinus/snapdrop) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15\
一个开源的文件分享服务，使用 WebRTC 协议进行点对点传输。

[tesseract.js](https://github.com/naptha/tesseract.js) ⭐ 38,712 | 🐛 53 | 🌐 JavaScript | 📅 2026-05-17\
![](https://www.wangbase.com/blogimg/asset/201906/bg2019062823.jpg)\
一个可以完成 62 种语言 OCR （光学识别）的 JS 库。

[如何使用 GitHub issue 作为博客后端？](https://github.com/ruanyf/weekly/issues/585) ⭐ 102,754 | 🐛 9,122 | 📅 2026-09-13\
...
[bat](https://github.com/sharkdp/bat) ⭐ 60,483 | 🐛 518 | 🌐 Rust | 📅 2026-09-04\
...
[CycleGAN](https://github.com/junyanz/CycleGAN) ⭐ 12,873 | 🐛 59 | 🌐 Lua | 📅 2023-09-12\
...
[faceai](https://github.com/vipstone/faceai) ⭐ 11,088 | 🐛 38 | 🌐 Python | 📅 2020-04-16\
...
[Python - 100天从新手到大师](https://github.com/jackfrued/Python-100-Days) ⭐ 186,556 | 🐛 716 | 🌐 Jupyter Notebook | 📅 2026-07-29\
一本针对初学者的 Python 教程。
...
这是很久以来，我见过的最酷主页，整个页面都是 3D 的。[页面源码](https://github.com/brunosimon/folio-2019) ⭐ 4,743 | 🐛 40 | 🌐 JavaScript | 📅 2024-05-25是开源的。
